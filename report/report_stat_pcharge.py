...
class mcisogem_report_stat_pcharge(osv.osv):
	_name = "mcisogem.report.stat.pcharge"
	...
	_depends = {'mcisogem.centre' : ['id','name'], 'mcisogem.police' : ['id','name'], 'mcisogem.exercice' : ['id','name','date_debut','date_fin']}
