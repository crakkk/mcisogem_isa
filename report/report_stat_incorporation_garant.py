...
class mcisogem_report_stat_incorporation_garant(osv.osv):
	_name = "mcisogem.report.stat.incorporation.garant"
	...
	# 				from
	# 				  	public.mcisogem_benf_incorpo, public.mcisogem_police,  public.mcisogem_exercice	
	# 				where
	# 					mcisogem_benf_incorpo.garant_id = %s and mcisogem_benf_incorpo.police_id = mcisogem_police.id and mcisogem_exercice.id = mcisogem_police.exercice_id
	# 				group by
