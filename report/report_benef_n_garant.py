...
class report_benef_n_garant(osv.osv):
	_name = "report.benef.n.garant"
	...
	def init_server(self, cr, uid, context):
		...
		cr.execute("select report_benef_garant(%s)", (garant_id,))
		...
		cr.execute("""
				...
				create or replace view report_benef_n_garant as (
					SELECT 
				 	...
				 	min(mcisogem_report_stat_benef_n_garant.id) AS id,  
					mcisogem_report_stat_benef_n_garant.exercice_id as exercice_id,
					mcisogem_report_stat_benef_n_garant.police_id as police_id,
					mcisogem_report_stat_benef_n_garant.nbr_benef_total as nbr_benef_total,
					mcisogem_report_stat_benef_n_garant.nbr_benef_inc as nbr_benef_inc,
					mcisogem_report_stat_benef_n_garant.nbr_benef_ret as nbr_benef_ret,
					mcisogem_report_stat_benef_n_garant.nbr_benef_suspend as nbr_benef_suspend


    			FROM mcisogem_report_stat_benef_n_garant

    			group by
					exercice_id, police_id, nbr_benef_total, nbr_benef_inc,  nbr_benef_ret, nbr_benef_suspend
				)""")
