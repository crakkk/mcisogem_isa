...
class report_bon_consultation(osv.AbstractModel):
	_name = 'report.mcisogem_isa.bon_consultation'
	# @api.multi
	def render_html(self, data=None):
		report_obj = self.env['report']
		report = report_obj._get_report_from_name('mcisogem_isa.report_bon_consultation')
		docargs = {
		'doc_ids': self._ids,
		'doc_model': mcisogem.prestation,
		'docs': self,
		}
		return report_obj.render('mcisogem_isa.report_bon_consultation', docargs)