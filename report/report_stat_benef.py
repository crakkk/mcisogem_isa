...
class mcisogem_report_stat_benef(osv.osv):
	_name = "mcisogem.report.stat.benef"
	...
	_depends = {'mcisogem.police' : ['id','name'] ,'mcisogem.garant' : ['id','name'] ,'mcisogem.exercice' : ['id','name','date_debut','date_fin'] }
