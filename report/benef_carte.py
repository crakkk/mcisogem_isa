...
class report_benef_carte(osv.AbstractModel):
	_name = 'report.mcisogem_isa.benef_carte'
	# @api.multi
	def render_html(self, data=None):
		report_obj = self.env['report']
		report = report_obj._get_report_from_name('mcisogem_isa.report_benef_carte')
		docargs = {
		'doc_ids': self._ids,
		'doc_model': report.mcisogem.recherche.benef.garant,
		'docs': self,
		}
		return report_obj.render('mcisogem_isa.report_benef_carte', docargs)